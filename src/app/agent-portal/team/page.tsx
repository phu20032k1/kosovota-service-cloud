...
type Member = { id: string; name: string; phone: string; email?: string | null; active: boolean; createdAt: string; _count?: { assignedServiceOrders: number } };
