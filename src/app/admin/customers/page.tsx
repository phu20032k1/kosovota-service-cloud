...
type Customer = {
  ...
  machines: { id: string; serial?: string | null; model: string; name?: string | null }[];
...
export default function CustomersPage() {
  ...
  return <main className="min-h-screen">
    <OperationsHeader title="Khách hàng 360°" subtitle="Tìm theo khách hàng hoặc số Seri máy; sửa, xóa từng hồ sơ hoặc xử lý hàng loạt" />
